...
//    final static int testnum = 3000;
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        try (BufferedWriter out = new BufferedWriter(new FileWriter("trace"))) {
                                ...
                                if (0 <= sel && sel < retpc && soldTicket.size() > 0) { // return ticket
                                    ...
                                    if ((ticket = soldTicket.remove(select)) != null) {
                                        ...
                                        if (tds.refundTicket(ticket)) {
                                            ...
                                            //out.write(preTime + " " + ThreadId.get() + " " + "TicketRefund" + " " + ticket.tid + " " + ticket.passenger + " " + ticket.route + " " + ticket.coach  + " " + ticket.departure + " " + ticket.arrival + " " + ticket.seat);
                                            //System.out.flush();
                                        } else {
                                            long postTime = System.nanoTime() - startTime;
                                    ...
                                    if ((ticket = tds.buyTicket(passenger, route, departure, arrival)) != null) {
                                        ...
                                        //out.write(preTime + " " + ThreadId.get() + " " + "TicketBought" + " " + ticket.tid + " " + ticket.passenger + " " + ticket.route + " " + ticket.coach + " " + ticket.departure + " " + ticket.arrival + " " + ticket.seat);
                                        soldTicket.add(ticket);
                                        //System.out.flush();
                                    } else {
                                        long postTime = System.nanoTime() - startTime;
                                        out.write(preTime + " " + postTime + " " + ThreadId.get() + " " + "TicketSoldOut" + " " + route + " " + departure + " " + arrival + "\n");
                                        //out.write(preTime + " " + ThreadId.get() + " " + "TicketSoldOut" + " " + route + " " + departure+ " " + arrival);
                                        //System.out.flush();
                                    }
                                    ...
                                    //out.write(preTime + " " + ThreadId.get() + " " + "RemainTicket" + " " + leftTicket + " " + route+ " " + departure+ " " + arrival);
                                    //System.out.flush();
